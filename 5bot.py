...
#======================================================================================================#
                ...
                ki.sendText(msg.to,"Hi jing 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Hi jing 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Hi jing 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say pekok"]:
                ki.sendText(msg.to,"Cok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Cok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Cok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Cv say pekok"]:
            ...
            elif msg.text in ["Cv say tolol"]:
                ki.sendText(msg.to,"Tolol 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Tolol 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Tolol 􀜁􀅔Har Har􏿿")
            elif msg.text in ["#welcome"]:
                ki.sendText(msg.to,"Selamat datang di Kandang babi")
                kk.sendText(msg.to,"Ngeue dulu yuk!")
...
#======================================================================================================#
                ...
                ki.sendText(msg.to,"Apa sih anjing 􀨁􀅴questioning􏿿")
...
#======================================================================================================#
                 ...
                 quote = ['Bacot asu Bot lu.','APA? Mau ngentot? ayo!.\nBot teriak Bot ','apa anjing','Muka Lu qontowl','Y','Henceut beurem','Ngewe yuk?']
